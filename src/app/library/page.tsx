      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
            <Music2 className="w-5 h-5 sm:w-6 sm:h-6 text-pink-400" />
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <div className="flex items-center p-1 rounded-xl bg-white/5 border border-white/10">
            <button
              ...
              className={`p-2 min-h-[36px] min-w-[36px] flex items-center justify-center rounded-lg transition-colors ${
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full bg-white/5 border border-white/10 rounded-xl pl-9 pr-4 py-2.5 text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-pink-500/50"
          />
        </div>
        ...
        <div className="flex items-center gap-2 overflow-x-auto custom-scrollbar pb-1.5 pt-0.5">
          ...
          {genres.map((genre) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all shrink-0 min-h-[36px] ${
                selectedGenre === genre
