    ...
    <div className="space-y-8 select-none pb-12">
      ...
      <div className="relative max-w-xl mx-auto">
        ...
        <input
          ...
          className="w-full bg-[#12121e] border border-white/10 rounded-full pl-12 pr-4 py-3.5 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 shadow-xl transition-all"
          autoFocus
        />
      </div>
      ...
      {!query.trim() ? (
        <div className="py-20 text-center text-zinc-500 space-y-3">
          ...
          <p className="text-sm font-medium">Type a song title, artist name, or genre to explore.</p>
        </div>
        ...
        <div className="py-20 text-center text-zinc-500 bg-white/[0.02] border border-white/5 rounded-2xl">
          <p className="text-base font-semibold text-zinc-300">Nothing matched your search.</p>
            ...
            <section className="space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {results.artists.map((artist) => (
                  <div
                    key={artist}
                    className="p-4 rounded-xl bg-white/[0.03] border border-white/5 flex items-center gap-3"
                  >
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-white">{artist}</h4>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {results.albums.map((album) => (
                  <div
                    ...
                    className="p-4 rounded-xl bg-white/[0.03] border border-white/5 flex items-center gap-3"
                  >
                    <Disc className="w-8 h-8 text-pink-400 shrink-0" />
                    <div className="min-w-0">
                      <h4 className="text-sm font-semibold text-white truncate">{album}</h4>
