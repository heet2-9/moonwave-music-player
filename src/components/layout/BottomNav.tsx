...
import { Home, Music2, Heart, ListMusic, Mic2, Search } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#09090e]/95 backdrop-blur-2xl border-t border-white/10 px-2 py-1 select-none">
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center flex-1 h-full rounded-xl transition-all relative py-1",
